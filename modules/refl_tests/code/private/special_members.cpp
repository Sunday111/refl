...
TEST(reflTest, SpecialMembers_CopyAssign)
{
    class ReflectedType
    {
    public:
...
TEST(reflTest, SpecialMembers_NoCopyAssign)
{
    class ReflectedType
    {
    public:
...
TEST(reflTest, SpecialMembers_MoveAssign)
{
    class ReflectedType
    {
    public:
...
TEST(reflTest, SpecialMembers_NoMoveAssign)
{
    class ReflectedType
    {
    public:
...
TEST(reflTest, SpecialMembers_Destructor)
{
    class ReflectedType
    {
    public:
